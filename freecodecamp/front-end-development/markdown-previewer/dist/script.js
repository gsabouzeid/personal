...
const App = () => {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement("textarea", { id: "editor", rows: 20, cols: 60, onChange: handleChange }, text), /*#__PURE__*/
    React.createElement("div", { id: "preview", dangerouslySetInnerHTML: { __html: marked.parse(text) } })));
